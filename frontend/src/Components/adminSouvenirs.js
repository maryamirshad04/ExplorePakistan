...
import { ShoppingCart,Shield, Home, Users, Map, Gift, Search, MapPin, Plus, Trash2, Edit, Save, X, Check, AlertTriangle, Tag } from 'lucide-react';
  ...
  const [souvenirs, setSouvenirs] = useState([
    {
      ...
      items: [
        { 
          ...
          location: "Best found in the walled city of Lahore, especially in Shahi Mohalla .",
          price: 1500,
    ...
    },
    {
      ...
      items: [
        { 
          ...
          location: "The town of Bhit Shah is famous for its Ajrak artisans.",
          price: 1200,
          image: "/api/placeholder/400/320",
          rating: 4.9,
